    ...
    function renderTable(list) {
        ...
        $.each(list, function(i, item) {
            html += `
                <tr>
                    <td>\${item.id}</td>
                    <td><img src="\${item.cultureImage}" class="thumb-img"></td>
                    <td>\${item.cultureTitle}</td>
                    <td>\${item.historyPeriod}</td>
                    <td>\${item.significance}</td>
                    <td>
                        <a href="/admin/culture/edit?id=\${item.id}" class="btn-edit">编辑</a>
