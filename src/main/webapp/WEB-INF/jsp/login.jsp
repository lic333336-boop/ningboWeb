...
<head>
    ...
    <style>
        ...
        .btn { width: 100%; padding: 10px; background-color: #1890ff; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 16px; }
        .btn:hover { background-color: #40a9ff; }
        .link { margin-top: 15px; display: block; color: #1890ff; text-decoration: none; font-size: 14px; }
        .error-msg { color: red; margin-bottom: 10px; display: none; }
    </style>
</head>
<body>
...
<div class="login-box">
    ...
    <div class="form-group">
        <label>用户名</label>
        <input type="text" id="username" placeholder="请输入用户名 (admin/student)">
    </div>
    <div class="form-group">
        <label>密码</label>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.code === 1) {
                    ...
                    $("#errorMsg").text(res.msg || "登录失败，请检查用户名或密码").show();
                }
            },
            error: function() {
